...
IMPORT_SCENARIOS = [
    *CATALOG_SCENARIOS,
    "stage-source-review-edit-cancel",
    "stage-source-choice-retains-review",
    "stage-summary-without-authority",
    "stage-label-correction",
    "stage-label-entry-collapse",
    "stage-label-entry-edit-policy",
    "stage-label-entry-edit-text",
    "stage-label-entry-refused",
    "stage-label-entry-portable",
    "review-focus-pending",
    "review-focus-success",
    "review-focus-refused",
    "review-focus-rejected",
    "review-focus-labels",
    "review-focus-newer-control",
    "review-focus-newer-labels",
    "review-focus-newer-body",
    "review-focus-overlay",
    "review-focus-source-edit-stale",
    "review-focus-route-stale",
    "review-focus-newer-review-stale",
    "review-focus-disable-redirect",
    "stage-create-safety",
    "stage-create-refusal-focus",
    ...
    "profiles-workbench-scope",
    "profiles-workbench-identity",
    "profiles-workbench-scroll-drafts",
    "profiles-folder-collapsed",
    "profiles-folder-expand-collapse",
    "profiles-folder-missing-root",
    "profiles-folder-missing-server",
    "profiles-folder-missing-profile",
    "profiles-folder-unreadable",
    "profiles-folder-too-broad",
    "profiles-folder-rerender-reset",
    "profiles-folder-hydration-race",
    "profiles-folder-root-noop",
    "profiles-folder-root-changed",
