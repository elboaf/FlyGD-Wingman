...
(function () {
  ...
  function paintIdentityScenario() {
    ...
    if (stage === 'check' || stage === 'candidate'
        || stage === 'name' || stage === 'roster') {
      WM.el('es-identify-check').click();
    }
    if (stage === 'name' || stage === 'roster') {
